...
/**
 * An implementation of the {@link MessageBinding} AsyncAPI model interface.
 */
public class MessageBindingImpl extends ExtensibleImpl<MessageBinding> implements MessageBinding, ModelImpl {
}
