...
@AsyncAPI(
    ...
    info = @Info(
        title = "MQTT Quickstart API",
        version = "1.0-SNAPSHOT",
        description = "In this guide, we are going to generate (random) prices in one component."
            + " These prices are written in a MQTT topic (prices)."
            + " A second component reads from the prices MQTT topic and apply some magic conversion to the price."
