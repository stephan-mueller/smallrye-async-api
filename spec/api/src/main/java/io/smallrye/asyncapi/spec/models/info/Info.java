 ...
 */
package io.smallrye.asyncapi.spec.models.info;
 ...
 *
 * The metadata may be used by clients if needed, and may be presented in editing or documentation tools.
 *
 * @see "https://www.asyncapi.com/docs/specifications/2.0.0/#a-name-infoobject-a-info-object"
 */
public interface Info extends Constructible, Extensible<Info> {
    ...
    /**
     * Returns the version of the AsyncAPI document for this Info instance.
     *
     * @return the version of the AsyncAPI document
     **/

    String getVersion();

    /**
     * Sets the version of the AsyncAPI document for this instance of Info to the given version.
     *
     * @param version the version of the AsyncAPI document
     */
    void setVersion(String version);

    /**
     * Sets the version of the AsyncAPI document for this instance of Info to the given version and returns this instance of
     * Info
     *
     * @param version the version of the AsyncAPI document
     * @return this Info instance
    ...
    /**
     * Sets this Info instance's URL to the Terms of Service for the API to the given String. The URL must be in the format of a
     * URL.
     *
