...
/**
 * The base interface for AsyncAPI model objects that can contain extensions.
 *
 * Extensions contain data not required by the specification and may or may not be supported by the tools you use.
 *
...
public interface Extensible<T extends Extensible<T>> {
     ...
     * @param value data not required by the specification. null values will be rejected (implementation will throw an
