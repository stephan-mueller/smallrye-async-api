 ...
 * attribute of a
 * {@link Schema} annotation. These types can be objects, but also primitives and arrays.
 */
...
public @interface SchemaProperty {
     ...
     * exclusive.
     *
     * If other properties are defined in addition to the ref property then the result is undefined.
     *
     ...
     *
     * The name is REQUIRED when the schema is defined within {@link io.smallrye.asyncapi.spec.annotations.Components}. The name
     * will be used as the key to add this schema to the 'schemas' map for reuse.
     *
     ...
     *
     * Value must be a valid number. Ignored if the value is an empty string or not a number.
     *
     ...
     *
     * Sets the maximum number of items in an array. This integer MUST be greater than, or equal to, 0. An array instance is
     * valid against
     * "maxItems" if its size is less than, or equal to, the value of this keyword. Ignored if value is Integer.MIN_VALUE.
     *
     ...
     * Only applicable if type=array.
     *
     * Sets the minimum number of items in an array. This integer MUST be greater than, or equal to, 0. An array instance is
     * valid against
     * "minItems" if its size is greater than, or equal to, the value of this keyword. Ignored if value is Integer.MAX_VALUE.
     *
     ...
     * Only applicable if type=array.
     *
     * Determines if the items in the array SHOULD be unique. If false, the instance validates successfully. If true, the
     * instance validates
     ...
     * request only. A
     * property MUST NOT be marked as both readOnly and writeOnly being true.
     *
